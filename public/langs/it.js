...
tinymce.addI18n("it", {
  ...
  "Focus to contextual toolbar":
    "Imposta stato attivo per la barra degli strumenti contestuale",
  "Insert link (if link plugin activated)":
    "Inserisci un collegamento (se \xe8 attivato l'apposito plugin)",
  "Save (if save plugin activated)":
    "Salva (se \xe8 attivato l'apposito plugin)",
  "Find (if searchreplace plugin activated)":
    "Trova (se \xe8 attivato l'apposito plugin)",
  ...
  "Media poster (Image URL)":
    "Poster dell'oggetto multimediale (URL dell'immagine)",
  "Paste your embed code below:":
    "Incolla il codice d'incorporamento di seguito:",
  Embed: "Incorpora",
  ...
  "Could not find the specified string.":
    "Impossibile trovare la stringa specificata.",
  ...
  "yuan character, in hong kong and taiwan":
    "simbolo dello yuan, Hong Kong e Taiwan",
  ...
  "Error: Form submit field collision.":
    "Errore: Conflitto di campi nel modulo inviato.",
  ...
  "Switch to or from fullscreen mode":
    "Attiva/disattiva la modalit\xe0 schermo intero",
  ...
  "Open popup menu for split buttons":
    "Apri il menu a comparsa per i pulsanti divisi",
  ...
  "ImageProxy HTTP error: Rejected request":
    "Errore HTTP ImageProxy: richiesta rifiutata",
  "ImageProxy HTTP error: Could not find Image Proxy":
    "Errore HTTP ImageProxy: impossibile trovare Image Proxy",
  "ImageProxy HTTP error: Incorrect Image Proxy URL":
    "Errore HTTP ImageProxy: URL Image Proxy non corretto",
  "ImageProxy HTTP error: Unknown ImageProxy error":
    "Errore HTTP ImageProxy: errore sconosciuto",
});
