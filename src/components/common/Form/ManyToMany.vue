...
<div class="border rounded p-2" :id="`field-${field.name}`">
    ...
    <div class="d-flex gap-2 mt-2">    
        <button class="btn btn-primary btn-sm" @click="onCreateNewClicked">Creare</button>
        <button class="btn btn-primary btn-sm" @click="onAddExistingClicked">Aggiungere</button>
    </div>
</div>
